# Generated by Django 4.1.2 on 2022-11-17 02:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo_file', models.ImageField(blank=True, max_length=254, null=True, upload_to=catalog.utilities.get_timestamp_path, validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'jpeg', 'bmp'])])),
                ('descriptions', models.TextField(blank=True, verbose_name='описание')),
                ('imageses', models.ImageField(blank=True, default='', upload_to=catalog.utilities.get_timestamp_path, verbose_name=' Доп Изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='catalog.order', verbose_name='Заявка')),
            ],
        ),
    ]
